...
async function timeUser(){
  ...
  if(!(u == undefined || u == null)){
    ...
    if(who.status=='none'){}
      ...
      HTML('#Bnick').innerHTML = `<span class="tag"title="스태프 훈장" style="display:none;"><img src="https://ifh.cc/g/rrOtdm.png" style = "height:28px;margin-right:2px;"></span>${who.nick} <span id='Bname'>(${who.name})`;
